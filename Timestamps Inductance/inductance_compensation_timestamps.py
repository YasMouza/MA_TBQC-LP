...
for P1 in P_values:
    ...
    model_phase1.write(f'Timestamps Inductance\\test_iteration_01_P{P1}_phase1.lp')
    ...
    # Phase 2: Berücksichtigung der Reaktoren
    model_phase2 = gp.Model("optimal_power_flow_phase2")
    k = model_phase2.addVar(lb=1, ub=50, vtype=GRB.INTEGER, name="k")
