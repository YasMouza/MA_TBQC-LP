...
for P1 in P_values:
    P2 = -5   # Last an Sammelschiene 2
    Q1 = -5   # Blindleistung an Sammelschiene 1
    Q2 = -5  # Blindleistung der Last an Sammelschiene 2
    ...
    model_phase1.addConstr(Q1 - V_product * (B[0][1] * sin_theta_diff) <= 0, name="q1")
    ...
    model_phase1.addGenConstrMax(delta_plus, [V[1], 1])
    model_phase1.addGenConstrMax(delta_minus, [1, V[1]])

    
    # Phase 1: Optimierungsfunktion
    ...
    if model_phase1.Status == GRB.INFEASIBLE:
        ...
        results.append([P1, "Feasible", Q_Comp.x, Q_cap, V[1].x, theta[0].x, theta[1].x, sin_theta_diff.x, cos_theta_diff.x])
    ...
    #model_phas2.write(f'Timestamps\\test_iteration_01_P{P1}_phase2
    # .lp')
