...
if __name__ == "__main__":
    B = [[0, 0.08], [0.08, 0]]
    Q_values = [-3, -2, -1, -0.1, 0, 0.1, 1, 2, 3]
    P1 = 1
    P2 = -1
    Q1 = 1
    Q_cap = 0.3
...
for Q2 in Q_values:
    ...
    compensation_type = "capacitive compensation" if Q2 <= 0 else "inductive Compensation"

    if model_phase1.Status == GRB.INFEASIBLE:
        results.append([Q2, "Infeasible", None, None, V1_value, compensation_type])
        ...
        results.append([Q2, "Feasible", Q_Comp, k_value, V1_value, compensation_type])
